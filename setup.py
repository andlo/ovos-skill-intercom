...
URL = "https://github.com/andlo/ovos-skill-intercom"
SKILL_CLAZZ = "Intercom"
PYPI_NAME = "ovos-skill-intercom"
...
setup(
    name=PYPI_NAME,
    version=get_version(),
    description="LAN intercom for OVOS - speak-only messaging between devices, never command execution",
    ...
    keywords="ovos skill voice assistant intercom multi-device messaging lan",
